...
<body>
    <div class="container">
        <h2 class="title__6">สิ่งที่ต้องได้รับ</h2>
        <div class="row">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="product-subtotal">ได้รับสินค้าแล้ว</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $i=1; $numcheck=0;?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-name">
                                            ...
                                            ?>
                                                    ...
                                                    <a>
                                                        {{Str::limit($test[$numcheck][$product_array]->data_product->product_name, 20)}}
                                                    </a><br>
                                            <?php
                                                }
                                            ?>
                                        ...
                                        <td class="product-subtotal">ยืนยันแล้วอยู่ระหว่างจัดส่ง</td>
                                        <td class="product-quantity">{{$myorder->updated_at->format('d-m-Y H:i')}}</td>
                                        <td class="product-subtotal"><a href="{{route('updateby.customer',$myorder->id)}}">คลิกเพื่อยืนยัน</a></td>
                                    </tr>
                                    <?php $i++; $numcheck++?>
                                @endforeach
                            </tbody>
