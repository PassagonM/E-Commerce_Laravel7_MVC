...
<body>
    <div class="container">
        <h2 class="title__6">รายการที่ต้องชำระ</h2>
        <div class="row">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th class="product-address">ที่อยู่</th>
                                    <th class="product-subtotal">ชำระเงิน</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($myorder as $myorder)
                                    <tr>
                                        ...
                                        <td class="product-subtotal"><a href="{{route('order.edit',$myorder->id)}}">คลิกเพื่อชำระ</a></td>
